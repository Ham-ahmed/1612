...
wget -O /var/volatile/tmp/$channel-$"version".tar.gz "https://raw.githubusercontent.com/Ham-ahmed/1612/refs/heads/main/channels_backup_OpenBlackhole_20251213_HAZEMWAHBA-CIEFP.tar.gz"
