...
echo -e "${CYAN}"
echo "################################################################"
echo "#   Start downloading and installing  levi45multicam_10.2-r4   #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/1612/refs/heads/main/enigma2-plugin-extensions-levi45multicammanager_10.2-r4_all.ipk"
IPK_NAME="enigma2-plugin-extensions-levi45multicammanager_10.2-r4_all.ipk"
