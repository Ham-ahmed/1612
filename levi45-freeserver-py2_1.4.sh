...
echo -e "${CYAN}"
echo "################################################################"
echo "# Start downloading and installing  levi45-freeserver-py2_1.4  #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/1612/refs/heads/main/enigma2-plugin-extensions-levi45-freeserver-py2_1.4_all.ipk"
IPK_NAME="enigma2-plugin-extensions-levi45-freeserver-py2_1.4_all.ipk"
